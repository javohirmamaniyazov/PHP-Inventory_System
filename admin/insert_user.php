                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($res)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning"><i class="icon-pencil"></i> Edit</button>
                                        <a href="delete_user.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"><i class="icon-trash"></i> Delete</a>
                                    </td>
